...
*/
	...
	public void OverallInputAlarms() throws InterruptedException {
		...
		SP.CapturingAudioPADDATAAlarmsColor(driver, inputRowValue); // works well. Captures Audio, pad and data overall alarms with title for the input based 
		//on index number by calling captureSilenceAlarmComponents common method to capture individual audio, pad and data alarms.
...
//		 SP.padSubComponentsColorsandStats(driver,index); //with sleep - null pointer exception. without sleep overallpad alarm doesn't match with individual pad alarms
	...
	//captures titles and pad subcomponents of all the inputs
	@Test
	public void silencePadSettingsPageCardTitle() throws InterruptedException {
