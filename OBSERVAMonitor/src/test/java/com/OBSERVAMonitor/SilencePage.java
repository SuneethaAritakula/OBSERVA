...
//					System.out.println("Audio Alarm "+(index+1)+" is: Green");
	...
	/*//01/10/19 - captures attribute class and Audio subcomponent alarm colors - works well but throws stale element exception when run with pad and data subcomponent alarm colors
	...
	//01/10/19 - captures attribute class and PAD subcomponent alarm colors - stale element exception when run with Audio & data subcomponent alarm colors
   ...
   //01/10/19 - captures Audio and PAD subcomponents size and text only- works well.
	...
	for(int j = 0;j<Titlesize1;j++)	
    {
		...
		String audio1 = "//*[@id='audio-row-0']/div[1][";
		String audio2 = "]/div/div/div";
...
public void padSubComponentsColorsandStats1(WebDriver driver, int index) 
{
...
public void silenceAudioSettingsPageCardTitle(WebDriver driver) throws InterruptedException {
...
public void silencePadSettingsPageCardTitle(WebDriver driver) throws InterruptedException {
	...
	for (int i = 1; i <= Titlesize; i++) {
   	...
   	padSubComponentsColorsandStats1(driver,i);

	 }
	}

public void AudioSubComponentsColorsandStats1(WebDriver driver, int index) 
{
...
public void padSubComponentsColorsandStats(WebDriver driver, int index) 
{
