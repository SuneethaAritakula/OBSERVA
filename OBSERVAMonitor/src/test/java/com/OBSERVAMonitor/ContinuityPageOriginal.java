...
public class ContinuityPageOriginal {
	...
	public void Titles(WebDriver driver, String cardNumber) {
		...
		String InputTitle = driver.findElement(By.xpath("//*[@id='continuity-card-"+cardNumber+"']/..//h4[@class= 'card-title' ]")).getText();
		System.out.println(InputTitle);
	}

	public void TitleandHeartSymbolAlarmcolour(WebDriver driver) throws InterruptedException 
	{
	...
	public void tblFirstInputW(WebDriver driver, String cardNumber) throws InterruptedException {

		Titles(driver, cardNumber);		
		...
		String header = driver.findElement(By.xpath("//*[@id='continuity-card-"+cardNumber+"']/div[1]/table/thead")).getText();
...

		{
			...
			for (int col = 1; col <= totalcols.size(); col++) {
				...
				String tdxpath1 = "//*[@id='continuity-card-"+cardNumber+"']/div[1]/table/tbody/tr[" + row + "]/td[";
				String tdxpath2 = "]";
	...
	public void inputStreamStatusV(WebDriver driver,String cardNumber) throws InterruptedException
	...
	public void inputStatusalarams(WebDriver driver,String cardNumber,int rowNum) throws InterruptedException
	...
	public String captureInputStreamHeaderStatus(WebDriver driver,String cardNumber) throws InterruptedException 
	{
	...
	public void inputStreamStatusS(WebDriver driver, int cardNumberS, String cardNumber) throws InterruptedException {
...
public void FramePhase(WebDriver driver, String cardNumber) throws InterruptedException {
